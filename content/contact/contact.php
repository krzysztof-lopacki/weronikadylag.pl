...
<body class="contact">
  ...
  <main>
    <section class="jumbotron jumbotron-fluid pb-0 bg-dark">
      <div class="bg o-5" style="background-image:url(/content/contact/images/contact-header.jpg);"></div>
      <div class="container text-white py-5">
        ...
        <div class="row mt-5">
          <div class="col-lg-5 offset-lg-2">
            <p class="in-top">If you would like to book a visit in the studio or would like to know more about a
              specific piece please, do not hesitate to contact. <strong>Contact details below.</strong></p>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-8 offset-lg-2">
            <h2 class="mt-5">Love to talk art!</h2>
          </div>
        </div>
      </div>
    </section>
